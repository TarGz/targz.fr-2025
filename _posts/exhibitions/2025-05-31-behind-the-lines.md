...
![Glass Installation View]({{ '/assets/images/exhibitions/2025-05-31-behind-the-lines/behindthelines-lodeve-1.webp' | relative_url }})
  <div class="image-columns-2">
    <img src="{{ '/assets/images/exhibitions/2025-05-31-behind-the-lines/behindthelines-lodeve-2.webp' | relative_url }}" alt="Pen Plotter in Action">
    <img src="{{ '/assets/images/exhibitions/2025-05-31-behind-the-lines/behindthelines-lodeve-4.webp' | relative_url }}" alt="Process Detail">
  </div>
![Final Installation View]({{ '/assets/images/exhibitions/2025-05-31-behind-the-lines/behindthelines-lodeve-3.webp' | relative_url }})